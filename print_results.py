...
# Prints summary statistics over the run
    ...
    for key in results_stats_dic:
        ...
        # Use the command startswith() to check whether a string starts with a 
        # particular substring. If the string starts with a specified substring, 
        #the startswith() method returns True; otherwise, the function returns False.
        if key.startswith("P"):
