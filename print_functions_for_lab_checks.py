...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        pct_corr_matches = ( n_match / n_images ) * 100
    
        # prints calculated statistics
        print("\n ** Statistics from calculates_results_stats() function:")
        print("Number of Images: {:2d}  \n Number of Dog Images: {:2d}  \n Number of Not Dog Images: {:2d} \n Percentage of correct dog matches: {:5.1f} \n Percentage of correct NOT dog matches: {:5.1f}  \n Percentage of correct dog Breed: {:5.1f} \n Percentage of correct match labels {:5.1f}".format(
        ...
        print("Number of Images: {:2d}  \n Number of Dog Images: {:2d}  \n Number of Not Dog Images: {:2d} \n Percentage of correct dog matches: {:5.1f} \n Percentage of correct NOT dog matches: {:5.1f}  \n Percentage of correct dog Breed: {:5.1f} \n Percentage of correct match labels {:5.1f}".format(
              ...
              pct_corr_breed, pct_corr_matches))
