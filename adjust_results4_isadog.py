...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as filename_list:
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            if results_dic[key][1] in dognames_dic:
                ...
                print("both labels are dogs - MATCH IS A DOG")  
            ...
            # appends (1,0) because only pet label is a dog
                ...
                print("classifier is NOT a dog but pet label is a dog - NOT A MATCH")
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            if results_dic[key][1] in dognames_dic:
                ...
                print("classifier is a dog but pet label is NOT a dog - NOT A MATCH")
            ...
            # appends (0, 0) because both labels aren't dogs
                ...
                print("both labels are NOT dogs - MATCH NOT A DOG")
